...
gene.to.show <- read.csv('Highlighted_gene_selected_with_isgs.csv')
...
tslp.inducd.gene <- c('CD80', 'CD40', 'CD86', 'FSCN1', 'CD44', 'ICAM1', 'SOCS2',
                      'CD274', 'CD200', 'ALDH1A2', 'PVR', 'DLL4', 'CCL22',
                      'CRLF2', 'IL7R', 'STAT5A', 'REL', 'CCL17')
