...
selected.genes <- c('CD80','LAMP3','CD40','CCR7','FSCN1','MARCKS',
                    'REL','RELB','NFKB1','IL7R','CRLF2','CCL17',
                    'CCL22','ISG15','MX1','IFIT2','STAT1','IFITM2','IFI44L')
...
selected.genes <- c('ITGAX','CD1C','CLEC10A','CD80','LAMP3','CD40',
                    'CCR7','FSCN1','MARCKS',
                    'CD274','CD200','FAS',
                    'CCL22','ICOSLG','EBI3',
                    'IL7R','CRLF2','STAT5A',
...
combined.df.sorted.dc2hm$Gene <- c(rownames(dc2hm.all),
                                   rownames(pamp.all),
                                   rownames(ifng.lps.all))
selected.genes.extended <- c('CD80', 'CD83', 'LAMP3', 'CD40', 'CCR7', 'MYO1C', 'FSCN1',
                             'CD44', 'MARCKS', 'REL', 'RELB', 'NFKB1', 'IL7R', 'CRLF2',
                              'CCL17', 'CD274', 'JAG1', 'CD200', 'SOCS2',
                             'FAS', 'ALDH1A2', 'EBI3', 'ICOSLG', 'DLL4', 'CCL22',
                             'ISG15','OAS1','MX1','IFI16','IFIT2')
combined.df.sorted.dc2hm.vis <- combined.df.sorted.dc2hm[combined.df.sorted.dc2hm$Gene %in% selected.genes.extended,]
combined.df.sorted.dc2hm.vis$Gene <- factor(combined.df.sorted.dc2hm.vis$Gene,
                                     levels = selected.genes.extended)
